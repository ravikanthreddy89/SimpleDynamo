...
public class Put3Listener implements OnClickListener {

	private static final String TAG = Put3Listener.class.getName();
	...
	public Put3Listener(TextView _tv, ContentResolver _cr) {
		mTextView = _tv;

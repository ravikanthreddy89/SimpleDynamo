...
public class Put1Listener implements OnClickListener {

	private static final String TAG = Put1Listener.class.getName();
	...
	public Put1Listener(TextView _tv, ContentResolver _cr) {
		mTextView = _tv;
